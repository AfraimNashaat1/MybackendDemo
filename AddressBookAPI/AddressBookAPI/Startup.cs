...
using RepositoryLayer.EF.Repositories;
using System;
...
namespace AddressBookAPI
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
          ...
          services.AddTransient(typeof(IBaseRepository<>), typeof(BaseRepository<>)).AddTransient(typeof(IReportService), typeof(ReportService)); 
